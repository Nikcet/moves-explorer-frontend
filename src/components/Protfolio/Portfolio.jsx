      ...
      <div className="portfolio__main">
        ...
        <ul className="portfolio__links">
          <li className="portfolio__item">
            <a href="https://nikcet.github.io/how-to-learn/" className="portfolio__link">
              <div className="portfolio__link-block">Статичный сайт</div>
              <img src={arrow} alt="" className="protfolio__link-arrow" />
            </a>
          </li>
          <li className="portfolio__item">
            <a href="https://nikcet.github.io/russian-travel/" className="portfolio__link">
              <div className="portfolio__link-block">Адаптивный сайт</div>
              <img src={arrow} alt="" className="protfolio__link-arrow" />
            </a>
          </li>
          <li className="portfolio__item">
            <a href="https://nikcet.github.io/mesto/" className="portfolio__link">
